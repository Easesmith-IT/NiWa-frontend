export const v1QueryKeys = {
  ...
  logs: ["v1", "logs"] as const,
  webhookLogs: ["v1", "webhook-logs"] as const,
  ...
  quotas: ["v1", "quotas"] as const,
  quotaForecast: ["v1", "quota-forecast"] as const,
  ...
  templates: ["v1", "templates"] as const,
  webhooks: ["v1", "webhooks"] as const,
  whatsappConnections: ["v1", "whatsapp-connections"] as const,
};
