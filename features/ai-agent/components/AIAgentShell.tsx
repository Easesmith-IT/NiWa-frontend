...
import type { useAIAgentOrchestration } from "../hooks/useAIAgentOrchestration";
...
import { AgentPlaygroundTab } from "./AgentPlaygroundTab";
import { AgentTemplateOverwriteModal } from "./AgentTemplateOverwriteModal";

export interface AIAgentShellProps {
  orchestration: ReturnType<typeof useAIAgentOrchestration>;
}

export const AIAgentShell: React.FC<AIAgentShellProps> = ({ orchestration }) => {
  const {
    agents,
    templates,
    testQuery,
